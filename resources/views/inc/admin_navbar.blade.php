<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="{{ url('/admin')}}">{{config('app.name', 'Brand')}} Admin Dashboard</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                <a class="nav-link" href="{{ url('/') }}">
                    ...
                    <span class="nav-link-text">Back to {{config('app.name', 'Brand')}} page</span>
                </a>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Settings">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse"
                    href="#collapseSettingsComponents" data-parent="#exampleAccordion">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            {{-- search bar  --}}
            {{-- <li class="nav-item">
                <form class="form-inline my-2 my-lg-0 mr-lg-2" action="{{URL::to('/search')}}" method='POST'>

...
<p class="font-italic text-center">All fields are required to be filled-in!</p>
    ...
    {!! Form::open(['action' => 'AdvertisementController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        <div class="form-group">
            ...
            {{Form::text('ad_name', '', ['class' => 'form-control', 'placeholder' => 'Advertisement Name'])}}
        </div>
        <div class="form-group">
            {{Form::label('company_id', 'Company ID (If appropriate - leave empty if unknown)')}}
            {{Form::text('company_id', '', ['class' => 'form-control', 'placeholder' => 'Company ID'])}}
        </div>
        ...
        <div class="form-group">
            ...
            {{Form::number('company_phone', '', ['class' => 'form-control', 'placeholder' => 'Phone Number', 'step' => '0.01', 'min' => '0'])}}
        </div>
        <div class="form-group">
            {{Form::label('company_phone_secondary', 'Secondary Telephone Number (Leave empty if not applicable)')}}
            {{Form::number('company_phone_secondary', '', ['class' => 'form-control', 'placeholder' => 'Secondary Phone Number', 'step' => '0.01', 'min' => '0'])}}
        </div>
        <div class="form-group">
            {{Form::label('company_contact_name', 'Client Contact Name')}}
            {{Form::text('company_contact_name', '', ['class' => 'form-control', 'placeholder' => 'Client Contact Name'])}}
        </div>
        <div class="form-group">
            {{Form::label('company_street', 'Comapny Street Address')}}
            {{Form::text('company_street', '', ['class' => 'form-control', 'placeholder' => 'e.g: 32 Gold Street'])}}
        </div>
        <div class="form-group">
            {{Form::label('company_town', 'Company Town/City')}}
            {{Form::text('company_town', '', ['class' => 'form-control', 'placeholder' => 'e.g: Birmingham'])}}
        </div>
        <div class="form-group">
            {{Form::label('company_county', 'Company County')}}
            {{Form::text('company_county', '', ['class' => 'form-control', 'placeholder' => 'e.g: Northamptonshire'])}}
        </div>
        <div class="form-group">
            {{Form::label('company_country', 'Company Country')}}
            {{Form::text('company_country', '', ['class' => 'form-control', 'placeholder' => 'e.g.: United Kingdom'])}}
        </div>
        <div class="form-group">
            {{Form::label('company_postcode', 'Company Postcode')}}
            {{Form::text('company_postcode', '', ['class' => 'form-control', 'placeholder' => 'Company Postcode'])}}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            {{Form::text('ad_sponsorband', '', ['class' => 'form-control', 'placeholder' => '(A-E)'])}}
        </div>
        <div class="form-group">
            {{Form::label('ad_from', 'Advertisement Active From')}}
            {{Form::date('ad_from', '', ['class' => 'form-control input-group-date', 'placeholder' => 'Ad Active From'])}}
        </div>
        <div class="form-group">
            {{Form::label('ad_until', 'Advertisement Active Until')}}
            {{Form::date('ad_until', '', ['class' => 'form-control input-group-date', 'placeholder' => 'Ad Active Until'])}}
        </div>
        {{-- <div class="form-group">
        ...
        <div class="form-group">
            ...
            {{Form::text('ad_signage_area', '', ['class' => 'form-control', 'placeholder' => 'e.g: 1/8'])}}
        </div>
        ...
        <div class="form-group">
            ...
            {{Form::text('ad_agreement_signed', '', ['class' => 'form-control', 'placeholder' => 'Digital Signature'])}}
        </div>
        {{-- <div class="form-group">
